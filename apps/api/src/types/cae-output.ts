 ...
 *
 * Defines the contract between CAE backend and frontend for structured responses.
 * Instead of returning raw text, CAE returns typed blocks that the frontend can render appropriately.
 */
